...
beforeAll(() => {
    // 直接修改i18n内部的当前语言设置
    Object.defineProperty(i18n, 'currentLang', { value: 'zh_CN', writable: true });
    ...
    it('should switch language correctly', () => {
        ...
        const { result } = renderHook(() => {
            return {
                ...
                switchLanguage: i18n.switchLanguage.bind(i18n)
            };
        });
        ...
        // 验证localStorage是否更新
        expect(localStorageMock.setItem).toHaveBeenCalledWith('clearpage_language', 'en');
    });
